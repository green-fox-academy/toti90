...
class BlogPost {
  ...
  getInfos() {
    console.log(`${this.title} titeled by ${this.authorName} posted at "${this.publicationDate}"
    ${this.text}`);
  }
...
let blogPost3 = new BlogPost("William Turton", "One Engineer Is Trying to Get IBM to Reckon With Trump", 
`Daniel Hanley, a cybersecurity engineer at IBM, doesn’t want to be the center of attention. 
When I asked to take his picture outside one of IBM’s New York City offices, he told me that he wasn’t really
tinto the whole organizer profile thing.`,
 "2017.03.28.")
